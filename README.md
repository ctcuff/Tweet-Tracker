# Tweet-Tracker
Like [Tweety for Android](https://github.com/ctcuff/Tweety-Android), this is a website to track the occurrences of a single or multiple keywords. How does it work? A when a user logs into Twitter, a Python server takes the auth tokens and uses those to connect to a status stream using [https://github.com/tweepy/tweepy](). When a tweet is received, that tweet is sent to the front-end via sockets.
